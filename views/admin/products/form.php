...
?>
<section class="title">
	<h4><?php echo lang('store_title_product_'.$this->method);?></h4>
</section>
...
<section class="item">
	...
	<div class="tabs">
		...
		<ul>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_html','html'); ?> <span><?php echo lang('required_label');?></span></label>
				<div class="input"><?php echo form_textarea('html',set_value('html', $product->html),'class="wysiwyg-simple" maxlength="1000" rows="7"'); ?></div>
			</li>
			
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_meta_description','meta_description'); ?> <span><?php echo lang('required_label');?></span></label>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_meta_keywords','meta_keywords'); ?> <span><?php echo lang('required_label');?></span></label>
			...
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_discount','discount'); ?> <span><?php echo lang('required_label');?></span></label>
				<div class="input"><?php echo form_input('discount',set_value('discount',$product->discount),'class="width-15 text" maxlength="10"'); ?></div>
			</li>
			
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_stock','stock'); ?> <span><?php echo lang('required_label');?></span></label>
				<div class="input"><?php echo form_input('stock',set_value('stock',$product->stock),'class="width-15 text" maxlength="10"'); ?></div>
			</li>
			
			<li class="<?php echo alternator('', 'even'); ?>">
				<label for="name"><?php echo lang('store_product_limited','limited'); ?> <span><?php echo lang('required_label');?></span></label>
